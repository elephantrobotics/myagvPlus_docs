...
- [Customized robot operating system](5.3.1-SystemInstructionManual.md)<br>
The myAGV Plus system not only has built-in environments such as ROS and Python, but is also equipped with robot development software such as VSCode, VNC, and SSH. 
...
- [myStudio](5.3.3-mystudio/README.md)<br>
  myStudio is a one-stop platform for using robots such as myAGV Plus. It is convenient for users to select different firmware and download it according to their own usage scenarios, while learning relevant teaching materials and browsing tutorial videos online.

- [myagv_UI](5.3.4-myagv_UI/user_manual.md)<br>
  The MyAGV_UI software is specifically designed for use with MyAGV Plus products. It lowers the user's threshold for use through graphical interfaces, providing a quick introduction to MyAGV Plus with just a click of a button. 
  It enables one-click startup for MyAGV Plus sensor communication and SLAM , one-click LED light replacement at the rear, and also includes functions for testing motors and cameras.

----
[← Previous Chapter](../../4-FirstInstallAndUse/README.md) | [Next Chapter →](../../6-ExamplesRobotsUsing/6.1-AGVPIus 270M5Pi Handle Control/README.md)