...
![Softeware Page](../../../resources/6-SDKDevelopment/6.3/6.3.3/desktop.jpg)

![Softeware Page](../../../resources/6-SDKDevelopment/6.3/6.3.3/desktop2.png)

## 1、 Language Switch

Select Chinese and English to switch the corresponding language.

![Language Choose](../../../resources/6-SDKDevelopment/6.3/6.3.3/language_choices_en.png "Choose Language")

## 2、 Laser Radar

![Radar Open](../../../resources/6-SDKDevelopment/6.3/6.3.3/radar_open_en.png "Open Radar")

![Radar Close](../../../resources/6-SDKDevelopment/6.3/6.3.3/radar_close_en.png "Close Radar")
...
* A new terminal appears on the desktop, indicating that the radar is successfully opened.  
   ![Radar Open](../../../resources/6-SDKDevelopment/6.3/6.3.3/radar_open_terminal.png "Open Radar")
...
![Basic Control](../../../resources/6-SDKDevelopment/6.3/6.3.3/basic_control_en.png "Basic Control")
...
### 3.1 Keyboard Control
   ...
   ![Keyboard terminal](../../../resources/6-SDKDevelopment/6.3/6.3.3/keyboard_terminal.png "Keyboard terminal")  
...
#### 2.1 Handle-Letter type
   ...
   ![JoyStick Alphabet](../../../resources/6-SDKDevelopment/6.3/6.3.3/joystick_terminal.jpg  "JoyStick Alphabet")
   ...
   ![JoyStick Alphabet](../../../resources/6-SDKDevelopment/6.3/6.3.3/joystick_alphabet.jpg)
...
#### 2.2 Handle-Digital type
   ...
   ![JoyStick Number](../../../resources/6-SDKDevelopment/6.3/6.3.3/joystick_terminal.jpg "JoyStick Number")

   >There are 7 buttons on the handle to control the car movement, as shown in the picture, 1~4 control the car forward and backward and left and right movement, 5 control the car counterclockwise rotation, 6 control the car clockwise rotation, 7 is the stop button.


   ![JoyStick Number](../../../resources/6-SDKDevelopment/6.3/6.3.3/joystick_number.png "JoyStick Number")

## 4. Map and Navigation


![Map Navigation](../../../resources/6-SDKDevelopment/6.3/6.3.3/map_navi_en.png "Map and navigation")
...
![Build Map](../../../resources/6-SDKDevelopment/6.3/6.3.3/build_map_en.png  "Build Map")
...
* Select the opened keyboard terminal and use the keyboard to control the car. The rviz space will build the map as the car moves. The trajectory is shown in the figure:  ![Gmapping Map](../../../resources/6-SDKDevelopment/6.3/6.3.3/gmapping_rviz.png  "Gmapping Map")

#### Cartographer

Click the drop-down box to select the Gmapping mapping method, and click the "Open Mapping" button to start mapping.

* Click the button and it will open a new terminal. If the terminal keeps scrolling the output data, the cartographer build file is successfully opened, and the terminal displays the following status:  ![Cartographer Map](../../../resources/6-SDKDevelopment/6.3/6.3.3/cartographer_terminal.png)
* When the code runs successfully, rviz will be opened, and the map and lidar information will be displayed in rviz, and the red arrow is the direction of the car. The interface is shown in the figure.   ![Cartographer Map](../../../resources/6-SDKDevelopment/6.3/6.3.3/cartograph_rviz.jpg)
* Select the opened keyboard terminal and use the keyboard to control the car. The rviz space will build the map as the car moves. The trajectory is shown in the figure:  ![Cartographer Track](../../../resources/6-SDKDevelopment/6.3/6.3.3/catograph_rviz2.jpg)
...
![Save Map](../../../resources/6-SDKDevelopment/6.3/6.3.3/save_map_en.png "Save Map")
...
![Save map terminal](../../../resources/6-SDKDevelopment/6.3/6.3.3/save_map.png)
...
![Map Navigation](../../../resources/6-SDKDevelopment/6.3/6.3.3/navagation_en.png "Map Navigation")  
...
![File Manager](../../../resources/6-SDKDevelopment/6.3/6.3.3/file_2.png)

#### 2、modify the launch file

1. Click to open Visual Studio Code in the top left corner to open the code editor.  
![vscode Icon](../../../resources/6-SDKDevelopment/6.3/6.3.3/vscode_icon.png)


2. Open the navigation_active.launch file in /home/ubuntu/myagv_ros/src/myagv_navigation/launch/ path.  
![modify launchfile1](../../../resources/6-SDKDevelopment/6.3/6.3.3/modify_launch1.png)


3、Replace the myroom2.yaml in line 5 with our own map file name map.yaml.  
![modify launch file2](../../../resources/6-SDKDevelopment/6.3/6.3.3/modify_launch2.png)
...
![Run launch File1](../../../resources/6-SDKDevelopment/6.3/6.3.3/run_launch1.jpg)  

1、Click on "2D Nav Goal" in the top toolbar.

![Run launch File3](../../../resources/6-SDKDevelopment/6.3/6.3.3/run_launch3.png)  
...
![Run launch File4](../../../resources/6-SDKDevelopment/6.3/6.3.3/run_launch4.jpg)  
...
![LED Light](../../../resources/6-SDKDevelopment/6.3/6.3.3/led_light_en.png "LED Light")
...
![Testing Function](../../../resources/6-SDKDevelopment/6.3/6.3.3/testing_en.png "Testing Function")
...
### 6.6 Restore
![Restore Function](../../../resources/6-SDKDevelopment/6.3/6.3.3/restore_en.png "Restore FUnction")  
...
![Log Area](../../../resources/6-SDKDevelopment/6.3/6.3.3/log_area_en.png "Log Area")
...
![Status Detecting](../../../resources/6-SDKDevelopment/6.3/6.3.3/status_add_en.png "Status Information")
...
---
[← SDK Development Guide Page](../../5-SDKDevelopment/README.md)  | [Next Section →](../../../6-ExamplesRobotsUsing/6.1-AGVPIus 270M5Pi Handle Control/README.md)
