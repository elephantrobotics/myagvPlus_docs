...
> **Notice**: There is no need to download and install the driver in the myAGV Plus system.

sers can click the button below to download the corresponding **CP210X** or **CP34X** driver compressed package according to the operating system they are using. After decompressing the compressed package, select the installation package corresponding to the number of bits of the operating system to install.
...
![P210X_install](../../../resources/6-SDKDevelopment/6.3/6.3.2/img/4.1.1.2-CP210X_install.gif)

## 1.3 How to distinguish CP210X and CP34X chips

- As shown in the figure below, open **Device Manager** and view **Ports (COM and LPT)**

![frimware_check](../../../resources/6-SDKDevelopment/6.3/6.3.2/img/4.1.1.3-firmware_check.gif)

- If **Port (COM and LPT)** displays **USB-Enhanced-SERIAL CH9102**, it is **CP34X chip**

![CP34X](../../../resources/6-SDKDevelopment/6.3/6.3.2/img/4.1.1.3-CP34X.jpg)

- If **Port (COM and LPT)** shows **Silicon Labs CP210x USB to UART Bridge**, it is **CP210X chip**

![CP210C](../../../resources/6-SDKDevelopment/6.3/6.3.2/img/4.1.1.3-CP210X.jpg)
