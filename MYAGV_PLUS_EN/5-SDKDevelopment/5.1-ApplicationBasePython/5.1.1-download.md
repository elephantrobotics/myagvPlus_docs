...
The Jetson Nano version comes with an Ubuntu (V-22.04) system and a built-in Python development environment, so you don't need to build and manage it.
...
[← Previous Page](README.md) | [Next Page →](5.1.2-API.md)
