...
| 7      | Power DC Input interface            | 12V 5A  | power input                                          |                         |
...
#### 1.7 Power DC Input interface : Use DC 2.5*5.1 power port; The myAGV can be charged using the factory-supplied 25.2V1A DC power adapter.
...
[← Previous Page](2.3-MechanicalStructureParameter.md) | [Next chapter →](../3-UserNotes/README.md)
