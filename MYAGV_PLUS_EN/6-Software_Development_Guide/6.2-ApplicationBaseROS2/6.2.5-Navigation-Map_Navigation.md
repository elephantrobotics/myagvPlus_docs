...
![move_base_1](../../resources/6-SDKDevelopment/6.2/6.2.7/move_base_1.png)
...
NAV2 map navigation demo video:

<video id="my-video" class="video-js" controls preload="auto" width="100%"
poster="" data-setup='{"aspectRatio":"16:9"}'>
<source src="https://download.elephantrobotics.com/video/myAGV%20Plus/myAGV%20Plus%20%E5%9C%B0%E5%9B%BE%E5%AF%BC%E8%88%AA-Navigation2.mp4"></video>
...
![map_saver_2](../../resources/6-SDKDevelopment/6.2/6.2.7/map_saver_2.png)
...
![navigation_edit_1](../../resources/6-SDKDevelopment/6.2/6.2.7/navigation_edit_1.png)

Find the parameter "map_file" and change **/map/map.yaml** to **/map/map_test.yaml**. Then save the modified file and exit. If no changes are made, the system will default to loading the **map.yaml** file.![navigation_edit_2](../../resources/6-SDKDevelopment/6.2/6.2.7/navigation_edit_2.png)
...
- #### 2 Compile file
  ...
  ![navigation_edit_3](../../resources/6-SDKDevelopment/6.2/6.2.7/navigation_edit_3.png)
...
![navigation_terminal](../../resources/6-SDKDevelopment/6.2/6.2.7/navigation_terminal.png)
...
![navigation](../../resources/6-SDKDevelopment/6.2/6.2.7/navigation.png)
...
![navigation_2](../../resources/6-SDKDevelopment/6.2/6.2.7/navigation_2.png)

![navigation_3](../../resources/6-SDKDevelopment/6.2/6.2.7/navigation_3.png)
...
- #### 6 Waypoint Following Mode
  ...
  ![navigation_4](../../resources/6-SDKDevelopment/6.2/6.2.7/navigation_4.png)

  Click Nav2 Goal to publish two navigation points

  ![navigation_5](../../resources/6-SDKDevelopment/6.2/6.2.7/navigation_5.png)

  Click the Start Waypoint Following in the lower left corner, and then navigation will proceed in order one by one.

  ![navigation_6](../../resources/6-SDKDevelopment/6.2/6.2.7/navigation_6.png)

  ![navigation_7](../../resources/6-SDKDevelopment/6.2/6.2.7/navigation_7.png)


---

[← Previous Page](6.2.4-Real-time_Mapping_with_Gmapping.md) | [Next Page →](6.2.6-Rtabmap.md)
