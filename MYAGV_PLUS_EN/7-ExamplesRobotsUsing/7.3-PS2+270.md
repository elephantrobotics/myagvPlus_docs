# myAGV Plus 270M5 Handle Remote Control Case

**Function**: Use the controller to operate the myAGV Plus 270M5 for movement

## 1 Hardware Installation
### Robotic Arm Installation

Mount the 270M5 on the AGV
...
The end effector can be equipped with a gripper or suction pump.
...
> The left side is the suction pump pins, the right side is the robotic arm pins
> GND -> GND
> 5V -> 5V
> G2 -> 2
> G5 -> 5
...
Insert the LEGO connector into the reserved slot on the claw

<img src="./img/g0.jpg" height="50%"  width="50%">

Align the gripper with the connectors inserted with the end effector socket of the robotic arm and insert it.
...
After executing the program, press and hold the handle's MODE button. When the MODE light on the handle turns red, you can release the MODE button.
...
### Start the Odometry Node and the Lidar Node
...
After running the following program, once the terminal prints the following information, you can start controlling:
**Robot arm controller initialized successfully**
...
<img src="./img/270.gif" width="80%" height="80%" alt="">
