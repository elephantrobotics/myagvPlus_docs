...
- Open myStudio, select the machine as `myAGV Plus`, and wait for the `USB Port` to be successfully recognized.
  ...
  <img src="../../../resources/6-SDKDevelopment/6.3/6.3.2/img/agvplus/1.png" width=800 />

- Click `LOGIN` button.

  <img src="../../../resources/6-SDKDevelopment/6.3/6.3.2/img/agvplus/2.png" width=800 />

- Click on `Basic` to enter the basic page.

  <img src="../../../resources/6-SDKDevelopment/6.3/6.3.2/img/agvplus/3.png" width=800 />

- Click to `Download` the firmware

  <img src="../../../resources/6-SDKDevelopment/6.3/6.3.2/img/agvplus/4.png" width=800 />

- Click to `Flash`

  <img src="../../../resources/6-SDKDevelopment/6.3/6.3.2/img/agvplus/5.png" width=800 />

- Burn success

  <img src="../../../resources/6-SDKDevelopment/6.3/6.3.2/img/agvplus/6.png" width=800 />
