...
1. 按下电源按钮，但按钮指示灯不亮.
   ...
   - 锂电池已进入电池保护模式。电压过低，无法为 myagv 供电。请使用 25.2V 电源适配器为 myagv [充电](#1-外部电缆连接)。<br>
...
3. 系统启动失败，无法成功进入系统桌面。
   ...
   - 系统文件已损坏。您可以尝试 [用最新的镜像系统替换它们。](../5-Basic_features/5.5-System_Image.md)

---

[← 上一页](4.2-ProductUnboxingGuide.md) | [下一章 →](../5-Basic_features/README.md)
