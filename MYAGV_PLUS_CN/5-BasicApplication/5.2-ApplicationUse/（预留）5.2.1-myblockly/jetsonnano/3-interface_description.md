...
打开 myBlockly，选择机器为 `myAGV plus`，选择端口，并选择波特率为 `115200`。

**`myAGV Plus` 版本端口为 `/dev/ttyACM0`;**

![1.1](../../../../resources/5-BasicApplication/5.2/5.2.1/1.1.png)

将一些程序块拖入工作区，然后点击运行按钮。

![1.2](../../../../resources/5-BasicApplication/5.2/5.2.1/1.2.png)
...
![2.1](../../../../resources/5-BasicApplication/5.2/5.2.1/2.1.png)

2. 连接机器

![2.2](../../../../resources/5-BasicApplication/5.2/5.2.1/2.2.png)

3. 设定速度

您可以自定义每个运动方向的速度。

  ![2.3](../../../../resources/5-BasicApplication/5.2/5.2.1/2.3.png)

4. 运动控制部分

  ![2.4](../../../../resources/5-BasicApplication/5.2/5.2.1/2.4.png)
